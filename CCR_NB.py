...
#		print(accurcay)
#		acc.append(accurcay)
#	np.savetxt('LGBP_Lions_Thousand_CCR_NB.csv', acc, delimiter = ',') 
	#GLCM
#	for i in range(len(loop_num)):
...
#		print(accurcay)
#		acc.append(accurcay)
#	np.savetxt('GLCM_Lions_Thousand_CCR_NB.csv', acc, delimiter = ',')  
...
#		print(accurcay)
#		acc.append(accurcay)
#	np.savetxt('GLCM_Lions_Lamp_CCR_NB.csv', acc, delimiter = ',') 
	#GLCM
#	for i in range(len(loop_num)):
#		print ('++++++++++++++++GLCM IRIS 测试集个数为:' + str(loop_num[i])+ '+++++++++++++++++++++++')
...
#		print(accurcay)
#		acc.append(accurcay)
#	np.savetxt('GLCM_Lions_SIT_CCR_NB.csv', acc, delimiter = ',')  
...
#		print(accurcay)
#		acc.append(accurcay)
#	np.savetxt('GLCM_RACE_CCR_NB.csv', acc, delimiter = ',')  
